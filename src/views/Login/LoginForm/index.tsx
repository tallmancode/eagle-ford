...
import './index.scss'
import { LoginField, type LoginFieldProps } from '@/views/Login/LoginField'
...
export const LoginForm: React.FC<{
  ...
  return (
    ...
    >
      ...
      <FormSubmit size="large" className={'bg-primary-500 hover:bg-primary-300 disabled:bg-primary-300'}>
