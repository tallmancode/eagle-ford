...
/**
 * ImageMedia — uses Payload size derivatives when available (via getOptimalMediaSize),
 * then lets Next.js Image build a responsive srcset from that capped source.
 */
