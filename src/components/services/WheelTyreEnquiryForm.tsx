...
export default function WheelTyreEnquiryForm() {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
      ...
      {/* Message */}
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="wt-message">Question / Comment</Label>
        <Textarea
          id="wt-message"
          value={form.message}
          onChange={(e) => setField('message', e.target.value)}
          placeholder="Tell us about your wheel or tyre needs..."
          className="min-h-28"
        />
      </div>
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex items-start gap-3">
          ...
          />
          <Label htmlFor="wt-privacy" className="leading-snug cursor-pointer">
